...
final doctorReviewsProvider = StreamProvider.family<List<DoctorReviewModel>, String>(
  (ref, doctorId) {
    return ref.read(reviewServiceProvider).getDoctorReviews(doctorId);
  },
);
...
final patientPrescriptionsProvider =
    StreamProvider.family<List<PrescriptionModel>, String>(
  (ref, patientId) {
    return ref.read(prescriptionServiceProvider).getPatientPrescriptions(patientId);
  },
);
...
final doctorPrescriptionsProvider =
    StreamProvider.family<List<PrescriptionModel>, String>(
  (ref, doctorId) {
    return ref.read(prescriptionServiceProvider).getDoctorPrescriptions(doctorId);
  },
);
